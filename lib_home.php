...
<body>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0px; border-radius: 15px;">
            <div class="container">
                <div class="navbar-header">
					...
					<a class="navbar-brand" href="lib_index.php?index">LIBRARAIAN PANEL </a>
                ...
                <div id="navbar" class="navbar-collapse collapse">
					...
					<li><a href="viewbooks.php?viewbooks">VIEW BOOKS</a></li>
					<li><a href="addcat.php?addcat">ADD CATEGORY</a></li>
					<li><a href="addpub.php?addpub">ADD PUBLISHER</a></li>
					<li><a href="addmembers.php?addmems">ADD MEMBER</a></li>
					<li><a href="view_members.php?viewmem">VIEW MEMBERS</a></li>
				    </ul>
 ...
 <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h2>Add Books</h2>
          <p>Welcome to the Online Library Management System the place where you can get your desired books easily.</p>
		...
		<div class="col-lg-4">
          ...
          <p>We have divided the books into different categories and the members can easily search the book from the given list of books and can read them. </p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
